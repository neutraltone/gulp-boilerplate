...
(function (GulpBoilerplate, $, undefined) {
  ...
  */
  ...
  GulpBoilerplate.helper = (function () {
    function _helper() {
      ...
      */
       ...
       *             This method will automatically search for element
       ...
       *                 If set to true then scan cookie even if user
       ...
       *   checkCookie : This will either be true or false. If set to true
       *   							 then scan cookie and remove if found even if user
       *   							 system support localStorage.
      ...
      return this.init(); /*this refer to GulpBoilerplate.helper.init()*/
    }
  ...
  /**
   * Check to evaluate whether 'GulpBoilerplate' exists in the global namespace - if not, assign window.GulpBoilerplate an object literal
   */
